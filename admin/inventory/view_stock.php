    ...
    <div class="card card-outline rounded-0 card-primary shadow">
        <div class="card-header bg-dark text-light">
            ...
            <div class="card-tools">
                <a href="javascript:void(0)" id="add_new" class="btn btn-primary"><span class="fas fa-plus"></span>  Add New Stock</a>
                <a class="btn btn-default border btn-flat text-light" href="./?page=inventory"><i class="fa fa-angle-left"></i> Back</a>
            </div>
        </div>
        <div class="card-body">
            <div class="container">
                    ...
                    <div class="col-md-6">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td class="px-2 py-1 align-middle text-center"><?= date('M d, Y H:i', strtotime($row['date_created'])) ?></td>
