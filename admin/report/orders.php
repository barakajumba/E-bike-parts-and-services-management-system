<style>
    ...
    table td, table th {
        padding: 5px !important; /* Increase padding for better spacing */
    ...
    .btn-primary:hover {
        ...
        border-color: #0056b3; /* Change primary button hover border color */
    }
    .btn-success {
        background-color: #28a745; /* Change success button color */
        border-color: #28a745; /* Change success button border color */
    }
    .btn-success:hover {
        background-color: #218838; /* Change success button hover color */
        border-color: #218838; /* Change success button hover border color */
    }
</style>
